...
<?php 
   $query = mysqli_query($conn,"select name,image from movies order by rand() limit 1");
...
<section class="slide fade-6 kenBurns">
  ...
  <div class="background" style="background-image:url(../images/<?php echo $row['image'] ?>.jpg)"></div>
</section>
